...
- `UniversalWaterHeaterApiClientError` (Base)
- `UniversalWaterHeaterApiClientCommunicationError` (Network, timeout, HTTP errors)
- `UniversalWaterHeaterApiClientAuthenticationError` (401, 403, invalid credentials)
