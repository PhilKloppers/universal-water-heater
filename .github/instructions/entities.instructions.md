...
- **`entity/`** - Base entity classes (inherit `UniversalWaterHeaterEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, UniversalWaterHeaterEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import UniversalWaterHeaterEntity`
