...
- `entity/` - Base entity class (`UniversalWaterHeaterEntity`)
...
- All entities inherit: `(PlatformEntity, UniversalWaterHeaterEntity)` - order matters for MRO
...
- Adjust log level: `custom_components.universal_water_heater: debug` in `config/configuration.yaml`
