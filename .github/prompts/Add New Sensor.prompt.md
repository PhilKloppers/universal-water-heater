...
- Create new sensor file in `custom_components/universal_water_heater/sensor/`
- Inherit from `UniversalWaterHeaterEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Universal Water Heater."""
...
class UniversalWaterHeater[SensorName]Sensor(
...
- Entity: `custom_components/universal_water_heater/sensor/[sensor_name].py`
- Platform: `custom_components/universal_water_heater/sensor/__init__.py`
- Translations: `custom_components/universal_water_heater/translations/*.json`
