...
**File:** `custom_components/universal_water_heater/services.yaml`
...
Create `custom_components/universal_water_heater/service_actions/[action_name].py`:

```python
"""[Action name] service action for Universal Water Heater."""
...
**File:** `custom_components/universal_water_heater/__init__.py`
...
**File:** `custom_components/universal_water_heater/const.py`
...
3. Find service action: `universal_water_heater.[action_name]`
...
- **Service actions directory:** `custom_components/universal_water_heater/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/universal_water_heater/services.yaml` (legacy filename)
- **Icons:** `custom_components/universal_water_heater/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/universal_water_heater/translations/*.json` under `services` key (legacy)
