...
- Inherit from `UniversalWaterHeaterEntity` and platform base class
...
- Entity: `custom_components/universal_water_heater/[platform]/[entity_name].py`
- Platform: `custom_components/universal_water_heater/[platform]/__init__.py`
