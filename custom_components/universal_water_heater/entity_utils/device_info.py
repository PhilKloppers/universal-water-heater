"""Device info utilities for universal_water_heater."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Universal Water Heater",
        manufacturer=manufacturer or "Universal Water Heater",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('universal_water_heater', 'entry_id_value')}
    """
