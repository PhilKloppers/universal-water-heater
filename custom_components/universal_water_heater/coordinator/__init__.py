"""
Data update coordinator package for universal_water_heater.
...
from .base import UniversalWaterHeaterDataUpdateCoordinator

__all__ = ["UniversalWaterHeaterDataUpdateCoordinator"]
